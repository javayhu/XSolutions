...
public class PathSum2_113_2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new PathSum2_113_2().pathSum(root, 10));
    }
    ...
    private void genPath(List<List<Integer>> result, LinkedList<Integer> path, TreeNode root, int sum) {
